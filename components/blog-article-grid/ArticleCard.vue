<template>
  <div
    class="flex flex-col justify-start items-start flex-grow relative overflow-hidden gap-7"
  >
    <div
      v-if="teaserImage?.src"
      class="self-stretch h-[300px] md:h-[220px] relative overflow-hidden rounded-lg"
    >
      <img
        loading="lazy"
